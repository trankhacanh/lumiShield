// ignore_for_file: lines_longer_than_80_chars, unnecessary_underscores, document_ignores, public_member_api_docs
...
import 'package:luminous_blocks_ui/src/attachments/widgets/widgets.dart';
  ...
  Widget _carousel({bool? isInView}) => CarouselSlider.builder(
    ...
    itemBuilder: (context, index, realIndex) {
      ...
      return switch ('') {
        ...
        _ when media is MemoryImageMedia => _MediaCarouselMemoryImage(
          media: media,
        ),
