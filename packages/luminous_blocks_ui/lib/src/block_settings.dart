// ignore_for_file: lines_longer_than_80_chars, no_self_assignments, parameter_assignments, document_ignores, public_member_api_docs
...
final class BlockSettings {
  ...
  late DateTimeTextDelegate dateTimeDelegate;
...
final class DateTimeTextDelegate {
  ...
  final String Function(DateTime) timeAgoShort;
}
